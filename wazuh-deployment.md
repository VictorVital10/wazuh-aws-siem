...
**Troubleshooting — disco cheio na instalação do wazuh-manager**
...
**Troubleshooting — certificado não aplicava no dashboard**
...
**Troubleshooting — agent preso em "Never connected"**
...
### Troubleshooting — destroy acidental
...
| Billing/FinOps | Cost Explorer verificado; parada manual de instância ociosa como prática adotada; automação em backlog |
